...
- **Minimum = smallest amount of functionality**
...
- **Feedback is being ignored**
   The team delivers what they consider as an MVP. They do not do any further changes to that product, regardless of feedback they receive about it.

## Resources for the MVP

- AgileAlliance: [Minimum Viable Product (MVP)](https://www.agilealliance.org/glossary/mvp)
